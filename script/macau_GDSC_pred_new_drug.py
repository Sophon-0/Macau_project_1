...
## loading data
name_of_response = 'IC50_ECFP4'    ##   IC50_ECFP4  IC50_target_Leiden  IC50
name_of_cell_feature = 'GEX'  ## GEX 
name_of_drug_feature = 'ECFP4'   ##   pathway , target , target_pathway , Target_Expansion  ECFP4  target_Leiden
## loading data
