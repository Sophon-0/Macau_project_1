...
# -*- coding: utf-8 -*-
"""
Created on Tue Oct  4 17:50:16 2016
@author: miyang
"""
...
os.chdir(path + 'DATA_RESULT_STORAGE/transduction')
interaction_mean.to_csv('interaction_'+name_of_drug_feature+'_'+name_of_cell_feature+'_'+name_of_response+'_fold'+'_sample'+str(nsamples)+'_latent'+str(num_latent)+'.csv') 
